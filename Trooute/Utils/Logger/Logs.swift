...
open class Logs {
    ...
    init() {
        ...
        let file = FileDestination()  // log to default smartid.log file
    ...
    class func fetchLogs() -> String {
        for destination in destinations {
            if let des = destination as? FileDestination {
                return des.loadFile()
            }
    ...
    class func deleteLogs() -> Bool {
        for destination in destinations {
            if let des = destination as? FileDestination {
                return des.deleteLogFile()
            }
    ...
    open class func custom(level: Logs.Level, message: @autoclosure () -> Any,
                             file: String = #file, function: String = #function, line: Int = #line, context: Any? = nil) {
    ...
    private class func dispatch_send(level: Logs.Level, message: @autoclosure () -> Any,
