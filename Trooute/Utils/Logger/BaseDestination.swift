...
open class BaseDestination: Hashable, Equatable {
    ...
    public init() {
        ...
        let queueLabel = "smartid-queue-" + uuid
    ...
    open func send(_ level: Logs.Level, msg: String, thread: String, file: String,
    ...
    func formatMessage(_ format: String, level: Logs.Level, msg: String, thread: String,
    ...
    func levelWord(_ level: Logs.Level) -> String {
    ...
    func colorForLevel(_ level: Logs.Level) -> String {
        var color = ""
    ...
    func shouldLevelBeLogged(_ level: Logs.Level, path: String,
